...
let reg = /meet/;
reg = /meet/g; //declared with global flag
reg = /mEEt/i; //case insensitivity flag
console.log(reg);
console.log(reg.source); //what did we write inside our reguler expression.
...
//if the value is not matching then in that case the above two error will be thrown.
